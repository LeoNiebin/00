---
title: Getting Started with Ethan project
excerpt: >-
...
You're on your way to building an awesome developer hub! Here are some things you'll want to check out.

# 📝 Customize your docs

What you're looking at right now is our **Guides**. It's a free-form place to write to your heart's content! And the best part is... You aren't alone! Your users can contribute (with your approval, don't worry!) using the **[Suggested Edits](https://docs.readme.com/main/docs/suggested-edits)** feature on every page. It's like GitHub Pull Requests, but for text!
